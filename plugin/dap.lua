...
cmd('DapToggleBreakpoint', function() require('dap').bp.toggle() end, { nargs = 0 })
cmd('DapEditBreakpoint', function() require('dap').bp_editor.open({ curline = true }) end, { nargs = 0 })
cmd('DapToggleBreakpointEnabled', function() require('dap').bp.toggle_enabled() end, { nargs = 0 })
cmd('DapEnableBreakpoint', function() require('dap').bp.enable() end, { nargs = 0 })
cmd('DapDisableBreakpoint', function() require('dap').bp.disable() end, { nargs = 0 })
cmd('DapClearBreakpoints', function() require('dap').bp.clear() end, { nargs = 0 })
cmd('DapShowBreakpoints', function() require('dap').bp_editor.open() end, { nargs = 0 })
cmd('DapNextBreakpoint', function() require('dap').bp.jump(1) end, { nargs = 0 })
cmd('DapPrevBreakpoint', function() require('dap').bp.jump(-1) end, { nargs = 0 })
