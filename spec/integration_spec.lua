...
describe('dap with fake server', function()
  ...
  it('jump to location results in nice error if location outside buffer contents', function()
    ...
    if vim.fn.has("nvim-0.12") == 1 then
      msg = "Adapter reported frame/breakpoint in buf %d line 40:3, but: Invalid cursor line: out of range. Ensure executable is up2date and if using a source mapping ensure it is correct"
    else
      msg = 'Adapter reported frame/breakpoint in buf %d line 40:3, but: Cursor position outside buffer. Ensure executable is up2date and if using a source mapping ensure it is correct'
    end
